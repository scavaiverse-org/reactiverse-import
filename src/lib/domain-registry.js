...
export const MUSEUM_ROUTE_TEMPLATES = [
  ...
  { path: "/museum/:tenantSlug/tour/:walkthroughIndex", label: "Walkthrough by Index", pageKey: "walkthrough" },
  { path: "/museum/:tenantSlug/begin-tour", label: "Begin Tour (legacy alias of tour/1)", pageKey: "walkthrough" },
  { path: "/museum/:tenantSlug/begin-tour-2", label: "Begin Tour 2 (legacy alias of tour/2)", pageKey: "walkthrough" },
  { path: "/museum/:tenantSlug/begin-tour-3", label: "Begin Tour 3 (legacy alias of tour/3)", pageKey: "walkthrough" },
  { path: "/museum/:tenantSlug/begin-tour-4", label: "Begin Tour 4 (legacy alias of tour/4)", pageKey: "walkthrough" },
  { path: "/museum/:tenantSlug/begin-tour-5", label: "Begin Tour 5 (legacy alias of tour/5)", pageKey: "walkthrough" },
