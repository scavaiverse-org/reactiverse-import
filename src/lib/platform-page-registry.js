...
export function createDefaultPlatformPageConfig(pageKey) {
  ...
  if (page.pageKey === "become_a_tenant") {
    return {
      ...
      sections: [
        {
          ...
          subtitle: "SCAVerse is for museum owners, cultural groups, curators, schools, galleries, heritage operators, and private collectors who want a visitor-ready virtual museum experience.",
      ...
      seo: { title: "Become a Tenant | SCAVerse", description: "Launch your own virtual museum without building software." },
      accessibility: { reducedMotionFallback: true, altText: "SCAVerse become a tenant cinematic background" },
  ...
  if (page.pageKey === "platform_home") {
    return {
      ...
      sections: [
        {
          ...
          overlayOpacity: 0.58,
          overlayColor: "6, 12, 24",
          systemColorAlignment: "SCAVerse primary gold, dark museum background, soft cyan accents",
          visibility: true,
          sortOrder: 1,
        },
      ],
      ...
      ctaSlots: [],
      seo: { title: "Home | SCAVerse", description: "Choose how you want to enter SCAVerse." },
      accessibility: { reducedMotionFallback: true, altText: "SCAVerse cinematic gateway background" },
      verificationReport: { status: "MANUAL_QA_REQUIRED", checks: [] },
      lastEditedAt: new Date().toISOString(),
    };
  }
  ...
  return {
    ...
    seo: { title: page.pageName, description: "SCAVerse platform system page." },
