...
const AUDIENCE_SELECTOR = {
  id: "choose_audience",
  title: "How would you like to use SCAVerse?",
  subtitle: "Choose your path. We will guide you from here.",
  visual: "◇",
  content: "SCAVerse connects visitors with immersive experiences, and gives tenants the tools to launch, manage, and grow their own spaces.",
  cta: "Continue",
  ...
  options: [
    ...
    { id: "franchisee", icon: Building2, label: "I am a Franchisee / Tenant", desc: "I want to understand how to list, manage, and grow my own space inside SCAVerse.", route_after_completion: "/become-tenant" },
  ],
};
...
const FALLBACK_CONSUMER_SLIDES = [
  {
    id: "consumer_welcome",
    audience: "consumer",
    title: "Welcome to SCAVerse",
    subtitle: "Your entry point into immersive places and experiences.",
    visual: "✦",
    content: "SCAVerse helps you discover museums, cultural spaces, pop-ups, shops, events, and interactive experiences in one simple journey.",
    cta: "Start exploring",
  ...
  },
  {
    ...
    visual: "◎",
    content: "Browse featured spaces, hidden gems, tenant museums, events, food spots, retail activations, and cultural experiences from one SCAVerse gateway.",
  ...
  },
  {
    ...
    visual: "◉",
    content: "SCAVerse can turn visits into stamps, missions, rewards, collectibles, discounts, and progress. Every place can become part of your personal trail.",
    cta: "See rewards",
  ...
  },
  {
    ...
    subtitle: "SCAVerse learns what kind of experiences you enjoy.",
    visual: "◆",
    content: "Choose what you like: art, heritage, food, family activities, shopping, nightlife, learning, games, or local discoveries. SCAVerse can guide you better from there.",
  ...
  },
  {
    ...
    subtitle: "Enter SCAVerse and start your journey.",
    visual: "⬢",
    ...
    animation: "The onboarding card zooms into a preview of the SCAVerse home/discovery feed; three panels appear for Nearby Experiences, Featured Tenant, and Rewards, then the final CTA glows once before navigating.",
    route: "/",
    options: [
      { id: "explore", icon: Compass, label: "Explore SCAVerse", desc: "Go to the main discovery gateway", route: "/" },
...
const FALLBACK_FRANCHISEE_SLIDES = [
  {
    id: "tenant_welcome",
    audience: "franchisee",
    title: "Launch Your Space on SCAVerse",
    subtitle: "Turn your location, brand, or collection into a discoverable experience.",
    visual: "◇",
    content: "SCAVerse gives tenants a platform layer to present their space, attract visitors, manage content, and build interactive journeys.",
    cta: "Build my presence",
    animation: "A plain storefront/gallery card appears, then transforms into a polished SCAVerse listing with a glowing outline as it \"goes live\".",
  ...
  },
  {
    ...
    visual: "◈",
    content: "SCAVerse can help tenants appear in discovery feeds, themed trails, featured sections, reward loops, and visitor journeys.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: "overview", icon: Globe, label: "View Platform Overview", desc: "Understand how SCAVerse works", route: "/platform/overview" },
