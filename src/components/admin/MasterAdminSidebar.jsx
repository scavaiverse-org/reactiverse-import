...
import {
  ...
  ClipboardCheck, Music, LayoutGrid, Archive, Mail
} from "lucide-react";
...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Contacts", path: "/platform/admin/contacts", icon: Mail },
    ]
  },
  {
    group: "Experience",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Inventory", path: "/platform/admin/inventory", icon: Archive },
